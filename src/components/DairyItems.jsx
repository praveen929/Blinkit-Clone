...
const DairyItems = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      price: "141",
      cutPrice: 145,
      moneySymbol: "&#8377;",  // Using escape code as a string
    },
    {
      image:
    ...
    {
      image:
        "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/da/cms-assets/cms/product/77e340a9-a133-434f-a326-2c9d334078fc.jpg?ts=1729169312",
      time: "19 MINS",
    ...
    {
      image:
        "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/6ae62ec2-3b13-4fff-b052-2ff3d4ef2d16.jpg?ts=1726473593",
      time: "19 MINS",
    ...
    {
      image:
        "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/2ea78d1e-8060-46e7-9be3-abed7446e676.jpg?ts=1723100674",
      time: "19 MINS",
  ...
  >
    <div className="w-full flex relative -left-[0.5rem] -top-[0.3rem] ">
      <p className="absolute left-3 top-[0.1rem] w-8 h-8 leading-3 text-white text-[0.55rem] font-bold tracking-widest whitespace-break-spaces text-center z-30">
        {item.discount}% OFF{" "}
      </p>
      {item.svg}
    </div>

    <img src={item.image} className="w-[89%] h-[47%] object-cover " />
    ...
    <div className="w-full h-1/2 flex flex-col items-start justify-center">
      ...
      <div className="w-full h-8 flex mt-2 items-center justify-between">
        <div className="mt-1">
          ...
          {/* Conditionally show cutPrice */}
          {item.cutPrice && (
            <s className="text-[#868686]">
              <p
                className="text-[12.5px] text-[#868686] font-semibold leading-3"
