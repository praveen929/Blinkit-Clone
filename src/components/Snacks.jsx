...
const Sancks = () => {
  ...
  const data = {
    ...
    prod4: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/images/products/sliding_image/366421a.jpg?ts=1690814947",
      time: "19 MINS",
      name: "Saras Curd",
      weight: "200g",
      price: "16",
    ...
    prod5: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/746586b3-e9bf-4ebf-a2ea-9af8471fecce.jpg?ts=1712325569",
      time: "19 MINS",
    ...
    prod6: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/0e8047b0-4ad0-4f89-a8f4-80d8b5988103.jpg?ts=1712325568",
      time: "19 MINS",
    ...
    prod9: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/2ea78d1e-8060-46e7-9be3-abed7446e676.jpg?ts=1723100674",
      time: "19 MINS",
    ...
    prod10: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/images/products/sliding_image/18403a.jpg?ts=1688988827",
      time: "19 MINS",
    ...
    prod11: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/da/cms-assets/cms/product/77e340a9-a133-434f-a326-2c9d334078fc.jpg?ts=1729169312",
      time: "19 MINS",
    ...
    prod13: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/65005872-46f3-4b09-915a-cc9690d3bee8.jpg?ts=1710494069",
      time: "19 MINS",
    ...
    prod15: {
      image: "https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/assets/products/sliding_images/jpeg/be2b8d5d-1d96-4392-a3e7-a8df23933584.jpg?ts=1710313956",
      time: "19 MINS",
  ...
  return (
    ...
    <div className="w-full h-full max-w-[3000px] lg:flex hidden flex-col items-center overflow-hidden justify-center">
      <div className="w-full flex max-w-[1250px] flex-col h-[376.45px]">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <button
            className={`${isAtStart ? "hidden" : "flex"} absolute w-10 left-[115px] items-center justify-center text-2xl h-10 rounded-full bg-white border shadow-2xl shadow-black`}
            onClick={scrollLeft}
          >
            {<MdKeyboardArrowLeft />} 
          </button>
              ...
              <div
               ...
               >
                  <div className="w-full flex relative -left-[0.5rem] -top-[0.3rem] ">
                          <p className="absolute left-3 top-[0.1rem]  w-8 h-8 leading-3 text-white text-[0.55rem] font-bold tracking-widest   whitespace-break-spaces text-center text-wrap z-30">{item.discount}% OFF </p>
                      {item.svg}
          ...
          <button
            className={`${isAtEnd ? "hidden" : "flex"} absolute w-10 right-[115px] items-center justify-center text-2xl h-10 rounded-full bg-white border shadow-2xl shadow-black`}
            onClick={scrollRight}
          >
